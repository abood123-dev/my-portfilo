  ...
  return (
    <div className="flex md:flex-row md:justify-center items-center md:gap-[200px] flex-col-reverse justify-center content-center mt-14 mb-6 md:mb-0">
         <div className="flex flex-col md:items-start justify-center items-cente  gap-5 md:w-[500px] w-[350px] md:mt-0  mt-10 md:-ml-10">
          ...
          <div className="flex md:flex-row md:justify-center items-center flex-col  md:ml-0 ml-0 md:gap-14 gap-9"> <a href="/cv for Abd Al-Fatah Al-haj Ibrahim (1).pdf" download >   <Button variant='outline' size='lg' className="uppercase flex items-center gap-2 rounded-full"><span className="text-sm">Download CV</span><FiDownload/> </Button> </a><div className="flex flex-row gap-3 justify-center items center"> <Socials/> </div> </div>
         </div>
         <div>
          <Photo/>
         </div>
